...
** on 2017-02-08 at 09:16:37 and should not be modified directly.
**
***********************************************************************************/
...
namespace Aci.X.Database
{
  ...
  public partial class AciXDB : DalSqlDb
  {
    ...
    /// <summary>
    /// AciXDB.spCategorySearch
    /// </summary>
    public int[] spCategorySearch(
      int intSiteID,
      int[] intExternalCategoryIDs)
    {
      return new spCategorySearch(_conn)
        .Execute(
          intSiteID: intSiteID,
          intExternalCategoryIDs: intExternalCategoryIDs);
    }
    ...
    /// AciXDB.spProductGet
    /// </summary>
    public DBProduct[] spProductGet(
      int intSiteID,
      int? intUserID=null,
      bool boolReturnAllSkus=false,
      int[] intProductIDs=null)
    {
      return new spProductGet(_conn)
        .Execute(
          intSiteID: intSiteID,
          intUserID: intUserID,
          boolReturnAllSkus: boolReturnAllSkus,
          intProductIDs: intProductIDs);
    }
    ...
    /// <summary>
    /// AciXDB.spSkuSetOfferToken
    /// </summary>
    public void spSkuSetOfferToken(
      int intSiteID,
      int intSkuID,
      string strOfferToken)
    {
      new spSkuSetOfferToken(_conn)
        .Execute(
          intSiteID: intSiteID,
          intSkuID: intSkuID,
          strOfferToken: strOfferToken);
    }
    ...
    /// <summary>
    /// AciXDB.spUserSubscriptionItemDebit
    /// </summary>
    public void spUserSubscriptionItemDebit(
      int intSiteID,
      int intUserID,
      int intItemSkuID)
    {
      new spUserSubscriptionItemDebit(_conn)
        .Execute(
          intSiteID: intSiteID,
          intUserID: intUserID,
          intItemSkuID: intItemSkuID);
    }

    /// <summary>
    /// AciXDB.spUserSubscriptionItemGet
    /// </summary>
    public DBUserSubscriptionItem[] spUserSubscriptionItemGet(
      int intSiteID,
      int intUserID)
    {
      return new spUserSubscriptionItemGet(_conn)
        .Execute(
          intSiteID: intSiteID,
          intUserID: intUserID);
    }
    ...
    /// <summary>
    /// AciXDB.spUserSubscriptionUpdate
    /// </summary>
    public int[] spUserSubscriptionUpdate(
      int intSiteID,
      int intUserID,
      string strSubscriptionXml)
    {
      return new spUserSubscriptionUpdate(_conn)
        .Execute(
          intSiteID: intSiteID,
          intUserID: intUserID,
          strSubscriptionXml: strSubscriptionXml);
    }
