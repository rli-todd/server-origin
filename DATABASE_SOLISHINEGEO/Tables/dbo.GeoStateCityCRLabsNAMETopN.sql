CREATE TABLE [dbo].[GeoStateCityCRLabsNAMETopN]
(
...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_GeoStateCityCRLabsNAMETopN] ON [dbo].[GeoStateCityCRLabsNAMETopN] ([StateFips], [CityFips], [ToStateFips], [ToCityFips], [RowNum]) ON [PRIMARY]
GO
