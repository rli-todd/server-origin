CREATE TABLE [dbo].[GeoStateCityFederalCircuitCourtsTopN]
(
...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_GeoStateCityFederalCircuitCourtsTopN] ON [dbo].[GeoStateCityFederalCircuitCourtsTopN] ([StateFips], [CityFips], [ToStateFips], [ToCityFips], [RowNum]) ON [PRIMARY]
GO
